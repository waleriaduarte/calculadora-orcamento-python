# Calculadora de Orçamentos (Projeto Conceitual)
...
Com o uso repetitivo e a pressão do dia a dia, erros humanos simples acabavam acontecendo, como:

* clicar em `+` em vez de `×` na calculadora;
* digitar um valor incorreto;
* errar algum número por pressa ou distração.
...
O objetivo não é apenas automatizar, mas também **tornar o processo mais controlado e deliberadamente mais lento**, reduzindo a chance de erros por impulsividade ou distração.

Em vez de cálculos manuais rápidos, o fluxo passa a ser:

1. inserir os valores com atenção;
